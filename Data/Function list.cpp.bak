...
DODAJ_FUNKCIJU( 3, ThinkLAP, printSidewaysTriangle );
DODAJ_FUNKCIJU( 3, ThinkLAP, luhnFormulaPrecomputed_and_Expression );
DODAJ_FUNKCIJU( 3, ThinkLAP, decodeMessage );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj1 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj2 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj2version2 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj3 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj5_check );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj5_generate );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj6 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj6_2 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj7 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj8 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog2vj9 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_finding_the_mode );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_vj1_sorting );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_highestSales_zadano );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_vj2_median );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_vj3_issorted );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_vj4_encode_and_vj5_decode );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_vj8_grade_better_than );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog3_vj9_modified_median );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_osnovne_operacije_stringa );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_prosjek_ocjena_studenata );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj1 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj2_jos_operacija_nad_stringom );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_myCharPtr_klasa_testiranje );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj4_dodavanje_and_vj5_uklananje_studentkih_rekorda );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj6 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj7 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj8 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj9 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog4_vj10 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog5_vj1 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog5_zad1 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog5_zad2 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog5_zad3_i_4 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog5_zad5 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_vj1 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_vj2 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_vj3 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_vj4 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_vj5 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_zad1 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_zad2 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_zad3 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_zad4 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_zad5 );
DODAJ_FUNKCIJU( 3, ThinkLAP, pog6_zad6 );
